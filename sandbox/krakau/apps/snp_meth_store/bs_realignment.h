#ifndef __SANDBOX_KRAKAU_APPS_SNP_METH_STORE_BS_REALIGNMENT_H__
#define __SANDBOX_KRAKAU_APPS_SNP_METH_STORE_BS_REALIGNMENT_H__

#include "../post_pro/bs_score_data.h"
#include "bs_score_data.h"
#include "bs_score.h"
#include "bs_consensus_realign.h"
