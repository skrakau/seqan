#ifndef SANDBOX_KRAKAU_APPS_POST_PRO_BS_SCORE_H_
#define SANDBOX_KRAKAU_APPS_POST_PRO_BS_SCORE_H_
                ...
                Left const &)
{
    ...
    for (unsigned i = 0; i < 5; ++i)
        for (unsigned j = 0; j < 5; ++j)
            std::cout << "Ref: " << (Dna5)i << "  read: " << (Dna5)j << " score: " <<  sc_data[62][i][j] << "  log10: " << std::log10(sc_data[62][i][j]) << std::endl;
}
                     ...
                     Left const &)
{
    ...
    std::cout << "Read gaps: " << std::endl;
    for (unsigned b = 0; b < 5; ++b)
            std::cout << "Ref: " << (Dna5)b << " score: " <<  sc_data[b] << "  log10: " << std::log10(sc_data[b])  << std::endl;
}
                    ...
                    Left const &)
{
    ...
    std::cout << "Ref. gaps: " << std::endl;
    for (unsigned b = 0; b < 5; ++b)
            std::cout << "Read: " << (Dna5)b << " score: " <<  sc_data[62][b]<< "  log10: " << std::log10(sc_data[62][b])  << std::endl;
}
